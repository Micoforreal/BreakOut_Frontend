...
export default class Weapon extends Component {
  ...
  Update(t) {
    ...
    const sideways = Input.GetKeyDown("KeyA") || Input.GetKeyDown("KeyD");
    const isWalking = forward || sideways;
    ...
    const offsetY =Math.sin(this.walkTime * this.bobFrequency) * this.bobAmplitude;
    // console.log(offsetY)
